...
var messages = map[MsgKey]map[Language]string{
	...
	MsgKeyTemplateCodeTitle: {
		LangEnglish:            "Code",
		LangChinese:            "代码结果",
		LangTraditionalChinese: "程式碼結果",
		LangJapanese:           "コード結果",
		LangSpanish:            "Resultado de código",
	},
	MsgKeyTemplateExplainTitle: {
		LangEnglish:            "Analysis",
		LangChinese:            "分析结果",
		LangTraditionalChinese: "分析結果",
		LangJapanese:           "分析結果",
		LangSpanish:            "Análisis",
	},
	MsgKeyTemplateProgressTitle: {
		LangEnglish:            "In Progress",
		LangChinese:            "正在执行...",
		LangTraditionalChinese: "正在執行...",
		LangJapanese:           "実行中...",
	...
	MsgKeyTemplatePermissionTitle: {
		LangEnglish:            "Permission Request",
		LangChinese:            "需要授权",
		LangTraditionalChinese: "需要授權",
		LangJapanese:           "許可が必要",
		LangSpanish:            "Requiere permiso",
	},
	MsgKeyTemplateErrorTitle: {
		LangEnglish:            "Error",
		LangChinese:            "⚠ 出错了",
		LangTraditionalChinese: "⚠ 出錯了",
		LangJapanese:           "⚠ エラー",
		LangSpanish:            "⚠ Error",
	},
	MsgKeyTemplateWarningTitle: {
		LangEnglish:            "Warning",
		LangChinese:            "⚠ 警告",
		LangTraditionalChinese: "⚠ 警告",
		LangJapanese:           "⚠ 警告",
		LangSpanish:            "⚠ Advertencia",
	},
}
